...
//tealium universal tag - utag.sender.7132 ut4.0.202011162150, Copyright 2020 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
    ...
    u.callBack = function() {
      ...
      u.map={"ad_word_universal_id":"conversion_id","gr_page_type:home":"page_view","gr_page_type:product_detail":"page_view","gr_page_type:cart":"page_view","gr_page_label":"custom.ecomm_pagetype,pagetype","gr_part_id":"custom.ecomm_prodid","gr_supplier_id":"custom.ecomm_supplier","newCustomer":"new_customer"};
  u.extend=[function(a,b){ try{ if((typeof b['page_type']!='undefined'&&b['page_type'].toString().toLowerCase()=='SC'.toLowerCase()&&/SCN$/i.test(b['page_sub_type']))){b['gr_page_type']='confirmation'} } catch(e){ utag.DB(e); }  },
function(a,b){ try{ if(1){
if (a === 'view') {
    var page_type_sub_type = b.page_type + "-" + b.page_sub_type;
    switch (page_type_sub_type) {
    case "HP-HP":
        b.gr_page_type = b.gr_page_label = "home";
        break;
    case "PS-PD":
        b.gr_page_type = b.gr_page_label = 'product_detail'
        b.gr_part_id = b.part_id;
        b.gr_supplier_id = b.supplier_id;
        break;
    case "SC-CO":
        b.gr_page_type = b.gr_page_label = "cart";
        break;
    case "SC-SCN":
