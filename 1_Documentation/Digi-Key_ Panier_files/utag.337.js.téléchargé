...
//tealium universal tag - utag.sender.17003 ut4.0.202104281925, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
...
if (typeof QSI.config === 'undefined') QSI.config = {};
QSI.config['externalReference'] = "";
if (typeof __headerLayout !== 'undefined' && typeof __headerLayout.registrationStatus !== 'undefined'
    && __headerLayout.registrationStatus.CustomerId >0) {
    QSI.config['externalReference'] = __headerLayout.registrationStatus.CustomerId;
} 
